...
<html lang="en">
    ...
    <body>
        <header>
            <div class="floater">
                <a id="toplogo" href="/">
                    <img width="40" height="38" alt="Logo" src="/tpl/logo.webp" width="40px">
                    <span>Jingga</span>
                </a>
            </div>
        </header>
