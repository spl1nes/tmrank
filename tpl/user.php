    ...
    <table id="maps">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php if ($hours > 0) { echo \sprintf("%02dh %02dm %02ds.%03d", $hours, $minutes, $seconds, $ms); } elseif ($minutes > 0) { echo \sprintf("%02dm %02ds.%03d", $minutes, $seconds, $ms); } else { echo \sprintf("%02ds.%03d", $seconds, $ms); } ?></td>
                <td><?php if ($fhours > 0) { echo \sprintf("%02dh %02dm %02ds.%03d", $fhours, $fminutes, $fseconds, $fms); } elseif ($fminutes > 0) { echo \sprintf("%02dm %02ds.%03d", $fminutes, $fseconds, $fms); } else { echo \sprintf("%02ds.%03d", $fseconds, $fms); } ?></td>
            <?php endforeach; ?>
    </table>
</div>
